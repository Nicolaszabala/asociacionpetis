                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700"> Atopa comprensión e acompañamento</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <span className="text-accent mr-3 mt-1">✓</span>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-br from-light to-accent rounded-lg p-6">
                    ...
                    Asiste a unha das nosas reunións semanais para coñecernos e ver se te sintes cómoda na comunidade.
                    </p>
                  </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <div className="bg-white rounded-2xl shadow-lg p-8 max-w-2xl mx-auto">
              ...
              <p className="text-lg text-gray-700 mb-4">
                <strong>Pazo da Cultura de Pontevedra</strong><br />
                Seminario 6, segundo andar<br />
                36002 Pontevedra
              </p>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 max-w-2xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-4">
              <strong>Antigo Priorato de Arra</strong><br />
