      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-700 mb-4">
            <strong>www.asociacionpetis.org</strong>
          </p>
          ...
          <p className="text-gray-700 mb-4">
            <strong>El objeto de las condiciones: El Sitio Web</strong><br />
          ...
          <p className="text-gray-700 mb-4">
            Asociación Petís de Apoio á crianza e á lactancia se reserva la facultad de modificar, en cualquier momento, y sin aviso previo, la presentación y configuración del Sitio Web y de los Contenidos y Servicios que en él pudieran estar incorporados. El Usuario reconoce y acepta que en cualquier momento Asociación Petís de Apoio á crianza e á lactancia pueda interrumpir, desactivar y/o cancelar cualquiera de estos elementos que se integran en el Sitio Web o el acceso a los mismos.
          </p>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">El Usuario</h3>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            El Sitio Web de Asociación Petís de Apoio á crianza e á lactancia proporciona gran diversidad de información, servicios y datos. El Usuario asume su responsabilidad para realizar un uso correcto del Sitio Web. Esta responsabilidad se extenderá a:
          </p>
          <ul className="list-disc pl-6 mb-4 text-gray-700">
            <li>Un uso de la información, Contenidos y/o Servicios y datos ofrecidos por Asociación Petís de Apoio á crianza e á lactancia sin que sea contrario a lo dispuesto por las presentes Condiciones, la Ley, la moral o el orden público, o que de cualquier otro modo puedan suponer lesión de los derechos de terceros o del mismo funcionamiento del Sitio Web.</li>
            <li>La veracidad y licitud de las informaciones aportadas por el Usuario en los formularios extendidos por Asociación Petís de Apoio á crianza e á lactancia para el acceso a ciertos Contenidos o Servicios ofrecidos por el Sitio Web. En todo caso, el Usuario notificará de forma inmediata a Asociación Petís de Apoio á crianza e á lactancia acerca de cualquier hecho que permita el uso indebido de la información registrada en dichos formularios, tales como, pero no solo, el robo, extravío, o el acceso no autorizado a identificadores y/o contraseñas, con el fin de proceder a su inmediata cancelación.</li>
          </ul>
          <p className="text-gray-700 mb-4">
            El mero acceso a este Sitio Web no supone entablar ningún tipo de relación de carácter comercial entre Asociación Petís de Apoio á crianza e á lactancia y el Usuario.
          </p>
          <p className="text-gray-700 mb-4">
            Siempre en el respeto de la legislación vigente, este Sitio Web de Asociación Petís de Apoio á crianza e á lactancia se dirige a todas las personas, sin importar su edad, que puedan acceder y/o navegar por las páginas del Sitio Web.
          </p>
          <p className="text-gray-700 mb-4">
            El Sitio Web está dirigido principalmente a Usuarios residentes en España. Asociación Petís de Apoio á crianza e á lactancia no asegura que el Sitio Web cumpla con legislaciones de otros países, ya sea total o parcialmente. Si el Usuario reside o tiene su domiciliado en otro lugar y decide acceder y/o navegar en el Sitio Web lo hará bajo su propia responsabilidad, deberá asegurarse de que tal acceso y navegación cumple con la legislación local que le es aplicable, no asumiendo Asociación Petís de Apoio á crianza e á lactancia responsabilidad alguna que se pueda derivar de dicho acceso.
          </p>
          ...
          <p className="text-gray-700 mb-4">
            Asociación Petís de Apoio á crianza e á lactancia no ofrece ni comercializa por sí ni por medio de terceros los productos y/o servicios disponibles en dichos sitios enlazados.
          </p>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            Asociación Petís de Apoio á crianza e á lactancia en ningún caso revisará o controlará el contenido de otros sitios web, así como tampoco aprueba, examina ni hace propios los productos y servicios, contenidos, archivos y cualquier otro material existente en los referidos sitios enlazados.
          </p>
          <p className="text-gray-700 mb-4">
            Asociación Petís de Apoio á crianza e á lactancia no asume ninguna responsabilidad por los daños y perjuicios que pudieran producirse por el acceso, uso, calidad o licitud de los contenidos, comunicaciones, opiniones, productos y servicios de los sitios web no gestionados por Asociación Petís de Apoio á crianza e á lactancia y que sean enlazados en este Sitio Web.
          </p>
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Hipervínculos</h3>
          <p className="text-gray-700 mb-4">
            El Usuario o tercero que realice un hipervínculo desde una página web de otro, distinto, sitio web al Sitio Web de Asociación Petís de Apoio á crianza e á lactancia deberá saber que:
          </p>
          <ul className="list-disc pl-6 mb-4 text-gray-700">
            <li>No se permite la reproducción —total o parcialmente— de ninguno de los Contenidos y/o Servicios del Sitio Web sin autorización expresa de Asociación Petís de Apoio á crianza e á lactancia.</li>
            <li>No se permite tampoco ninguna manifestación falsa, inexacta o incorrecta sobre el Sitio Web de Asociación Petís de Apoio á crianza e á lactancia, ni sobre los Contenidos y/o Servicios del mismo.</li>
            <li>A excepción del hipervínculo, el sitio web en el que se establezca dicho hiperenlace no contendrá ningún elemento, de este Sitio Web, protegido como propiedad intelectual por el ordenamiento jurídico español, salvo autorización expresa de Asociación Petís de Apoio á crianza e á lactancia.</li>
            <li>El establecimiento del hipervínculo no implicará la existencia de relaciones entre Asociación Petís de Apoio á crianza e á lactancia y el titular del sitio web desde el cual se realice, ni el conocimiento y aceptación de Asociación Petís de Apoio á crianza e á lactancia de los contenidos, servicios y/o actividades ofrecidas en dicho sitio web, y viceversa.</li>
          </ul>
