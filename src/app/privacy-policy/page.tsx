    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-gray-100">
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-700 mb-4">
            Respetando lo establecido en la legislación vigente, Asociación Petís de Apoio á crianza e á lactancia (en adelante, también Sitio Web) se compromete a adoptar las medidas técnicas y organizativas necesarias, según el nivel de seguridad adecuado al riesgo de los datos recogidos.
          </p>
          ...
          <p className="text-gray-700 mb-4">
            Las categorías de datos que se tratan en Asociación Petís de Apoio á crianza e á lactancia son únicamente datos identificativos. En ningún caso, se tratan categorías especiales de datos personales en el sentido del artículo 9 del RGPD.
          </p>
          <h3 className="text-xl font-semibold text-gray-900 mb-2">
            Base legal para el tratamiento de los datos personales
          </h3>
          <p className="text-gray-700 mb-4">
            La base legal para el tratamiento de los datos personales es el consentimiento. Asociación Petís de Apoio á crianza e á lactancia se compromete a recabar el consentimiento expreso y verificable del Usuario para el tratamiento de sus datos personales para uno o varios fines específicos.
            <br />
          ...
          <ul className="list-disc pl-6 mb-4 text-gray-700">
            ...
            <li><strong>Derecho de oposición:</strong> Es el derecho del Usuario a que no se lleve a cabo el tratamiento de sus datos de carácter personal o se cese el tratamiento de los mismos por parte de Asociación Petís de Apoio á crianza e á lactancia.</li>
          ...
          <p className="text-gray-700 mb-4">
            Así pues, el Usuario podrá ejercitar sus derechos mediante comunicación escrita dirigida al Responsable del tratamiento con la referencia "RGPD-www.asociacionpetis.org", especificando:
            <br />
            ...
            <br />
            <strong>Dirección postal:</strong> Rua Lepanto 7, Pontevedra
            <br />
            <strong>Correo electrónico:</strong> asociacionpetis@gmail.com
          </p>
          <h3 className="text-xl font-semibold text-gray-900 mb-2">
            Enlaces a sitios web de terceros
          </h3>
          <p className="text-gray-700 mb-4">
            El Sitio Web puede incluir hipervínculos o enlaces que permiten acceder a páginas web de terceros distintos de Asociación Petís de Apoio á crianza e á lactancia, y que por tanto no son operados por Asociación Petís de Apoio á crianza e á lactancia. Los titulares de dichos sitios web dispondrán de sus propias políticas de protección de datos, siendo ellos mismos, en cada caso, responsables de sus propios ficheros y de sus propias prácticas de privacidad.
          </p>
          <h3 className="text-xl font-semibold text-gray-900 mb-2">
            Reclamaciones ante la autoridad de control
          </h3>
          <p className="text-gray-700 mb-4">
            En caso de que el Usuario considere que existe un problema o infracción de la normativa vigente en la forma en la que se están tratando sus datos personales, tendrá derecho a la tutela judicial efectiva y a presentar una reclamación ante una autoridad de control, en particular, en el Estado en el que tenga su residencia habitual, lugar de trabajo o lugar de la supuesta infracción. En el caso de España, la autoridad de control es la Agencia Española de Protección de Datos (<a href="https://www.aepd.es/" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">https://www.aepd.es/</a>).
          </p>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
          ...
          <p className="text-gray-500 text-xs">
            Este documento de Política de Privacidad de un sitio web ha sido creado mediante el generador de plantilla de política de privacidad web gratis online el día 01/08/2025.
          </p>
        </div>
      </section>
    </div>
